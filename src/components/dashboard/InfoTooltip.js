...
const InfoTooltip = ({ description, formula }) => (
  <span className="relative group inline-flex items-center ml-2">
    ...
    <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-72 bg-slate-800 text-white text-xs rounded-lg shadow-xl p-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none z-[9999]">
      <div className="mb-2">
