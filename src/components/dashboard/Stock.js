                    ...
                    <div className="bg-white rounded-xl p-4 sm:p-6 mb-8">
                      ...
                      <div className="hidden md:block">
                        <ResponsiveContainer width="100%" height={250}>
                          <LineChart data={effChartData} margin={{ top: 20, right: 30, left: 70, bottom: 46 }}>
                            <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
                            <XAxis dataKey="day" tickFormatter={(day) => `Day ${day}`} stroke="#64748b" label={{ value: "Day", position: "insideBottom", offset: 12, dx: 20, fill: "#64748b", fontSize: 12 }} />
                            <YAxis tickFormatter={(value) => { if (value >= 1000000) return `₱${(value/1000000).toFixed(1)}M`; if (value >= 1000) return `₱${(value/1000).toFixed(0)}k`; return `₱${value}`; }} stroke="#64748b" label={{ value: "Revenue (₱)", angle: -90, position: "insideLeft", offset: 14, dy: -13, fill: "#64748b", fontSize: 12 }} />
