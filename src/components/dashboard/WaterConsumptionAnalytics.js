                          ...
                          <div className="hidden md:block">
                            <ResponsiveContainer width="100%" height={220}>
                              <BarChart
                                ...
                                margin={{ top: 5, right: 4, left: 58, bottom: 46 }}
                                barSize={8}
                              >
                                ...
                                <XAxis
                                  ...
                                  axisLine={false}
                                  tickLine={false}
                                  label={{ value: "Day", position: "insideBottom", offset: 34, dx: 27, fill: "#64748b", fontSize: 12 }}
                                />
                                <YAxis
                                  tick={{ fontSize: 10 }}
                                  stroke="#94a3b8"
                                  axisLine={false}
                                  tickLine={false}
                                  label={{ value: "Consumption (gal)", angle: -90, position: "insideLeft", offset: 12, dy: -20, fill: "#64748b", fontSize: 12 }}
                                />
                                <Tooltip
